...
fix_columns <- function(data, col.event, col.start, col.end, col.group, col.color,
  ...
  # Preserve the color_is_categorical attribute
  color_is_categorical <- attr(data, "color_is_categorical")
  ...
  result <- data[, c("event", "start", "end", "group", "tooltip", "label", "col", "fontcol")]

  # Re-attach the color_is_categorical attribute to the result
  attr(result, "color_is_categorical") <- color_is_categorical
