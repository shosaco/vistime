...
- `vistime()` objects can be integrated into [Shiny](https://shiny.rstudio.com/) via `plotlyOutput()` and `renderPlotly()`. Using the arguments `source` and `customdata`, you can pass information to the click event.
