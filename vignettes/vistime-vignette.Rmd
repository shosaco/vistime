...
```{r eval=FALSE}
vistime(data, col.events = "event", col.start = "start", col.end = "end", col.group = "group", col.color = "color", 
...
gg_vistime(data, col.events = "event", col.start = "start", col.end = "end", col.group = "group", col.color = "color",
           col.fontcolor = "fontcolor", optimize_y = TRUE, linewidth = NULL, title = NULL, 
           show_labels = TRUE, background_lines = 10)

vistime_data(data, col.events = "event", col.start = "start", col.end = "end", col.group = "group", col.color = "color", 
